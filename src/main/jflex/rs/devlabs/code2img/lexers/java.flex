...
<YYINITIAL> {
  ...
  "("                            { return token(TokenType.DEFAULT,  PARAN); }
  ")"                            { return token(TokenType.DEFAULT, -PARAN); }
  "{"                            { return token(TokenType.DEFAULT,  CURLY); }
  "}"                            { return token(TokenType.DEFAULT, -CURLY); }
  "["                            { return token(TokenType.DEFAULT,  BRACKET); }
  "]"                            { return token(TokenType.DEFAULT, -BRACKET); }
...
<JDOC> {
  ...
  "@"                            {
                                     yybegin(JDOC_TAG);
                                     long start = tokenStart;
                                     tokenStart = yychar;
                                     long len = tokenLength;
                                     tokenLength = 1;
