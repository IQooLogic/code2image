 ...
 */
public class LucarioTheme implements Theme {

    protected LucarioTheme() {
    }

    @Override
    public Color background() {
        return new Color(43, 62, 80);
    }
